...
def example_generator(data_path, single_pass):
  ...
  while True:
    ...
    examples.append(example_pb2.Example.FromString(example_str))
  return examples
...
def outputids2words_greedy(id_list, vocab, article_oovs):
...
def outputids2words_beam(id_list, vocab, article_oovs):
  words = []
  for i in id_list:
    try:
      w = vocab.id2word(i)  # might be [UNK]
